...
import { UsedCarContainer } from "./style";
import {
  BtnContainer,
  ButtonLeft,
  CompareBox,
...
import HmenuUsedcar from "./hmenuusedcar/HmenuUsedcar";
import VmenuComponents from "../Vmenu";

const UsecCarComponents = () => {
    ...
    <div>
      ...
      <MiddelContainer>
        ...
        <MiddelRight>
          ...
          {display === 'hmenu' ? <HmenuUsedcar />: <VmenuComponents/>}
        </MiddelRight>
      </MiddelContainer>
    </div>
  );
...
export default UsecCarComponents;
